...
>(({ children, className, style, ...props }, ref) => {
  return (
    <motion.button
      ref={ref}
      // force the primary shine color to white:
      style={{ "--primary": "#ffffff", ...style } as React.CSSProperties}
      className={cn(
    ...
    >
      <span
        className="relative block w-full text-sm tracking-wide text-white dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
