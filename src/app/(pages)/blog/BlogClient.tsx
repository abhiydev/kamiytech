  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100 text-gray-800">
      ...
      <main className="flex-1 flex flex-col items-center text-center px-4 py-20">
        <h1 className="text-4xl font-bold mb-2">KamiyTech Insights & Blog</h1>
        <p className="text-lg max-w-2xl mb-8 text-gray-600">
          Articles on custom software development, Next.js, mobile app trends, and business automation in India.
        </p>
