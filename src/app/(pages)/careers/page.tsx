...
const CareerPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Application submitted for', selectedJob, formData);
  ...
  return (
    <>
      <Navbar />
      <Head>
        <title>Careers – KamiyTech</title>
        <meta name="description" content="Join KamiyTech—view and apply for open positions in software development, design, and more." />
      </Head>
      ...
      <main className="bg-gray-50 py-16">
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          ...
          <p className="text-center text-gray-600">
            Explore open positions and apply to be part of KamiyTech’s growing family.
          </p>
