    ...
    <div className="flex flex-col min-h-screen bg-[url('/paper-texture.svg')] bg-cover">
      ...
      <div>
        ...
        <div className="relative -mt-1">
          <svg viewBox="0 0 1440 200" className="w-full h-40 md:h-60" preserveAspectRatio="none">
            <path
              fill="#E0F2FE"
        ...
        <main className="flex-grow container mx-auto px-6 py-12 space-y-16">
          ...
          <section>
            ...
            <div className="flex space-x-4 overflow-x-auto py-4">
              {[
                ...
                { name: 'Abhishek Chedwal', role: 'Founder & CEO/CTO' },
          ...
          <section className="bg-white bg-opacity-80 rounded-xl shadow-lg p-6">
            <h2 className="text-3xl font-semibold mb-4 text-center">🏢 Our Office Location</h2>
